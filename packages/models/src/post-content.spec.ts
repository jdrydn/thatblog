...
import { getItemFromDynamoDB, putItemInDynamoDB } from '../test/items';

import * as postContents from './post-content';
...
describe('#createContentItems', () => {
  ...
  const create: postContents.PostContentItem = {
    type: 'MARKDOWN',
    value: 'Hello, world!',
  };
...
describe('#updateContentItems', () => {
  ...
  const update: postContents.PostContentItem = {
    type: 'MARKDOWN',
    value: 'Updated copy!',
  };
